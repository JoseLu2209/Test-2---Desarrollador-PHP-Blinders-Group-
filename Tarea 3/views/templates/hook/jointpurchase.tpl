        ...
        <div class="dbjointpurchase_footer">
            <span class="precio_pack_product">
                <span class="num_products">
                    <span class="num">{$productos|@count}</span> 
                    {l s='producto(s) por' mod='dbjointpurchase'}
                </span>
                <span class="precio_pack_product_total">
                    <span class="regular_price">{$total_price}</span>
...
<!-- Aquí empieza la sección de productos relacionados -->
<div class="related-products">
    <h4>{l s='You might also like' d='Modules.Dbjointpurchase.Shop'}</h4>
    <div class="related-products-container">
        {foreach from=$products_cat item=product}
